...
export class CategoryController {
    ...
    async createCategory(@Body() createCategoryPayload: CreateCategoryDto, @UploadedFile() image: Express.Multer.File): Promise<{ message:string,new_category:CreateCategoryDto}> {
