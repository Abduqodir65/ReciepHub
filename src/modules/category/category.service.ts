...
export class CategoryService {
    constructor(@InjectModel(Category) private categoryModel: typeof Category, private readonly fileService: FileService ) { }
    ...
    async createCategory(payload: CreateCategoryDto, file:Express.Multer.File): Promise<{ message:string; new_category:Category}> {
    ...
    async updateCategory(id:number,payload: UpdateCategoryDto): Promise<{ message: string, updatedCategory: Category }> {
